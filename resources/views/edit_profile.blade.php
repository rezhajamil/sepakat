            ...
            <div class="flex-auto p-6">
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                        <div class="mb-4">
                            <label for="nik"
                                class="inline-block mb-2 ml-1 text-xs font-bold text-slate-700 ">NIK</label>
                            <input type="text" name="nik" value="{{ old('nik', $user->nik) }}" readonly
                                class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded border border-solid border-gray-300 bg-gray-200 bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-orange-500 focus:outline-none" />
                            @error('nik')
                    ...
                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                        <div class="mb-4">
                            ...
                            <input type="text" name="email" value="{{ old('email', $user->email) }}" readonly
                                class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded border border-solid border-gray-300 bg-gray-200 bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-orange-500 focus:outline-none" />
                            @error('email')
                                <span class="text-sm italic font-light text-red-600">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                        <div class="mb-4">
                            <label for="phone"
                                class="inline-block mb-2 ml-1 text-xs font-bold text-slate-700 ">Telepon</label>
